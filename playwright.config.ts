...
// NOTE: AUTH_FILE is now generated by a STUBBED setup (see global-setup.ts)
// that injects a mock session cookie instead of real Clerk login.
// TODO: replace with real Clerk test-mode login once account issue is resolved.
...
export default defineConfig({
  ...
  projects: [
    ...
    // setup writes AUTH_FILE with a stubbed cookie — see tests/e2e/global-setup.ts
    {
      name: 'teardown',
