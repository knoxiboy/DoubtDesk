  ...
  return (
    ...
    >
      ...
      <main className="flex-1 relative overflow-hidden scroll-smooth">
        ...
        <section className="px-4 sm:px-6 lg:px-12 xl:px-20 pt-20 sm:pt-24 lg:pt-28 xl:pt-32 pb-14 sm:pb-20 relative z-10">
          <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-12 xl:gap-16 items-center">
            <div className="text-center xl:text-left space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-left-6 duration-700 ease-out">
              {/* Primary Header Typography */}
              <h2 className="text-3xl min-[380px]:text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.07] max-w-xl sm:max-w-2xl mx-auto xl:mx-0 transition-colors duration-300">
                Empower <br />
                Your Learning <br />
                with{" "}
                <span
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center justify-center xl:justify-start gap-3 sm:gap-4 transition-all duration-300 max-w-md sm:max-w-2xl mx-auto xl:mx-0">
                <SignedIn>
                  <Link href="/rooms" className="w-full sm:w-auto">
                    <button className="group w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-4 sm:py-5 bg-[#5E8CFF] text-white rounded-2xl text-base sm:text-lg font-bold hover:bg-[#8BB8FF] hover:shadow-[0_0_24px_rgba(94,140,255,0.35)] transition-all flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]">
                      <span
                ...
                <SignedOut>
                  <Link href="/sign-up" className="w-full sm:w-auto">
                    <button className="group w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-4 sm:py-5 bg-white text-slate-950 rounded-2xl text-base sm:text-lg font-bold hover:bg-slate-200 transition-all flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]">
                      <span
                        className={`${staatliches.className} uppercase tracking-[0.08em]`}
                      >
                        Open
                ...
                <Link href="/public-rooms" className="w-full sm:w-auto">
                  <button className="group w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-4 sm:py-5 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-900 dark:text-white rounded-2xl text-base sm:text-lg font-bold border border-slate-200 dark:border-white/10 transition-all hover:shadow-[0_0_20px_rgba(94,140,255,0.15)] flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]">
                    <span
                      className={`${staatliches.className} uppercase tracking-[0.08em]`}
                    >
                      Explore Community
            ...
            <div className="flex items-center justify-center xl:justify-end w-full pt-4 xl:pt-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 ease-out fill-mode-both">
              <div className="w-full max-w-sm sm:max-w-md lg:max-w-xl xl:max-w-full transition-transform duration-500 hover:scale-[1.01] rounded-[0.9rem]">
