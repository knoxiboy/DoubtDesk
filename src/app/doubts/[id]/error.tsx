...
export default function DoubtDetailError({
  ...
  useEffect(() => {
    console.error("[DoubtDesk] Doubt detail error:", error);
  }, [error]);
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">
            Couldn&apos;t load this doubt
          </h2>
          <p className="text-sm text-slate-500 dark:text-zinc-400 leading-relaxed">
            Something broke while fetching this doubt thread. It might have been removed or there was a temporary issue.
          </p>
        </div>
