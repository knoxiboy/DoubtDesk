            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 bg-slate-50/30 dark:bg-zinc-950/10 border border-dashed border-slate-200 dark:border-zinc-900 rounded-2xl text-center px-6 shadow-sm">
                <div className="w-16 h-16 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl flex items-center justify-center mb-6 shadow-sm">
                  <Search className="w-7 h-7 text-slate-400 dark:text-zinc-600" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight mb-2">No Results Found</h3>
                <p className="text-slate-500 dark:text-zinc-400 max-w-sm mx-auto font-medium text-xs leading-relaxed mb-6">
                  No bookmarks match &quot;{searchQuery}&quot;. Try a different subject or keyword.
                </p>
                <button
                  onClick={() => setSearchQuery("")}
                  className="px-6 py-3.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold uppercase tracking-wider text-xs transition-all duration-300 shadow-lg shadow-purple-600/10 active:scale-[0.98]"
                >
                  Clear Search
                </button>
              </div>
